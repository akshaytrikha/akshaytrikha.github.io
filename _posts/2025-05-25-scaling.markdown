...
<!-- $$
\begin{align}
&\overbrace{\begin{matrix}\phantom{e_{11}}&\cdots&\phantom{e_{1d}}\end{matrix}}^{\text{embedding }(d)}
\;\Big|\;
\overbrace{\begin{matrix}\phantom{x_1}&\phantom{y_1}&\phantom{z_1}\end{matrix}}^{\text{xyz }(3)}
\\[-0.4em]
&\left[
\begin{array}{ccc|ccc}
