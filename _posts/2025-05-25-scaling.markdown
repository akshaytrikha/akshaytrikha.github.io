...
<br>
**Win #3: Making a scaling law run tool**
...
A tough lesson I also learned that the models just want to learn and given enough parameters the loss will go down even if it isn't learning the right thing.
...
- [[] Open Materials 2024 Dataset](https://huggingface.co/datasets/facebook/OMAT24)
- [[] Neural message passing for quantum chemistry](https://arxiv.org/pdf/1704.01212)
- [[] EquiformerV2](https://arxiv.org/pdf/2306.12059)
<!-- - [[] Symmetry From Scratch: Group Equivariance as a Supervised Learning Task](https://arxiv.org/html/2410.03989v1) -->
- [[] Naturally Occurring Equivariance in Neural Networks](https://distill.pub/2020/circuits/equivariance/)
<!-- - [[] All-atom Diffusion Transformers Encoder](https://github.com/facebookresearch/all-atom-diffusion-transformer/blob/main/src/models/encoders/transformer.py) -->
